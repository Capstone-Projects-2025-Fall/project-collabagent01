...
export function getSupabase(): SupabaseClient {
  ...
  if (!url || !anonKey) {
    throw new Error('Supabase not configured. Set collabAgent.supabase.url & collabAgent.supabase.anonKey in Settings or export SUPABASE_URL and SUPABASE_ANON_KEY environment variables.');
  }
